...
class FallbackClassifier:
    ...
    TECHNICAL_HINTS = {"bug", "error", "crash", "crashed", "freeze", "frozen", "latency", "slow", "broken", "failed", "delay", "minutes"}
    QUALITY_HINTS = {"quality", "accuracy", "accurate", "wrong", "hallucination", "incorrect", "inaccurate", "missing", "realistic", "unrealistic", "sober"}
